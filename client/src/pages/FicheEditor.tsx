      ...
      <main className="mx-auto grid max-w-[1300px] gap-6 px-5 py-7 lg:grid-cols-[290px_1fr]">
        ...
        <div className="space-y-6">
          ...
          <EditorSection
            ...
            note="Portrait recadré automatiquement à 400 × 400 sous 30 ko; logo sous 80 ko"
          >
            <div className="media-pair">
              <MediaPicker
                title="Portrait"
                value={form.photo}
                required={features.requiresProfile && !form.logo}
              ...
              <MediaPicker
                title="Logo"
                value={form.logo}
                required={features.requiresProfile && !form.photo}
          ...
          {features.hasCatalog && (
            <EditorSection
              ...
              note="Au moins une section est exigée pour activer une fiche Signature"
            >
              <CatalogEditor
  ...
  return (
    <div className="space-y-4">
      {sections.map((section, sectionIndex) => (
        <div className="catalog-editor-section" key={sectionIndex}>
          <div className="repeater-row">
            <input
          ...
          <div className="mt-3 space-y-2">
            {section.articles.map((article, articleIndex) => (
              <div className="catalog-editor-article" key={articleIndex}>
                <input
                    ...
                    onChange(
                      sections.map((item, i) =>
                        i === sectionIndex
                          ? {
                              ...item,
                              articles: item.articles.map((a, ai) =>
                                ai === articleIndex
